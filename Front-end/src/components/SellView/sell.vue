    ...
    <div class="flex flex-col gap-6 ">
        ...
        <div class="flex gap-8">
            <div class="flex flex-col gap-2">
                ...
                <input type="text" v-model="form.titre" class="flex-auto p-4 block  rounded-lg font-medium outline-none border focus:border-green-500 focus:text-green-500" name="" id="" placeholder="House">
            </div>
            <div class="flex flex-col gap-2">
                <label for="">Price</label>
                <input type="number" v-model="form.price" class="flex-auto p-4 block  rounded-lg font-medium outline-none border focus:border-green-500 focus:text-green-500" name="" id="" placeholder="$">
            </div>
        </div>
        <div class="flex flex-col gap-2">
            <label for="">Street</label>
            <input type="text" v-model="form.street" class="flex-auto p-4 block  rounded-lg font-medium outline-none border focus:border-green-500 focus:text-green-500" name="" id="" placeholder="600 Silliman St San Francisco, CA 94134">
        </div>
        <div class="flex flex-col gap-2"> 
            <label for="">City</label>
            <input type="text" v-model="form.city" class="flex-auto p-4 block  rounded-lg font-medium outline-none border focus:border-green-500 focus:text-green-500" name="" id="" placeholder="New york">
        </div>
