<script setup>
    ...
    const deleteData = (id) => {
      axios.delete('http://127.0.0.1:8000/api/supprime/' + id)
      .then(() => {
        realstateStore.fetchClient();
      });
    }
              ...
              <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                  <table class="min-w-full">
                    ...
                    <tbody v-for="clients in realstateStore.client">
                            <tr  class="bg-gray-100 border-b">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ clients.id }}</td>
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <button @click="deleteData(clients.id)" class="font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500">delete</button>
                                </td>
                            </tr>
                    </tbody>
                  </table>
