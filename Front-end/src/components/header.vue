    ...
    <header class="">
        ...
        <nav class="relative px-4 py-4 flex justify-between items-center bg-blue-500">
            ...
            <ul  class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                <li><a class="text-sm text-white hover:text-gray-500" href="/">buy</a></li>
            ...
            <div v-if="token">
                    <button @click="logout" class=" lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" >logout</button>
            </div>
        ...
        <div class="navbar-menu relative z-50 hidden" >
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
                ...
                <div class="mt-auto">
                    ...
                    <div v-if="token">
                        <button @click="logout" class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" >logout</button>
                    </div>
